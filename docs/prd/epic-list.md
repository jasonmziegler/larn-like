...
**Epic 0: Infrastructure & Development Setup** _(Archived - MVP Scope Reduction)_
~~Establish complete development environment, external service integration, and deployment infrastructure.~~ Local development environment established. Supabase, CI/CD deployment, and external service integration deferred to post-MVP.
...
_Note: MVP scope is single-player, local-only. Backend services (Supabase, authentication, multiplayer sync, web3) are deferred to post-MVP._
